...
const GUIDE: GuideItem[] = [
  ...
  },
  {
    ...
    body: 'Tüm öğrenci listesi ve her birinin profili burada — hedef program, net gelişim grafiği, deneme geçmişi, konu yeterliliği ve görevler dört sekmede. Profil başlığında telefonların yanında devamsızlık sayısı da görünür (tıklayınca Devamsızlık ekranına gider). "Deneme Geçmişi" sekmesinde bir denemeye tıklayınca bölüm bazlı doğru/yanlış/boş/net tablosu açılır ve sonucu oradan WhatsApp ile paylaşabilirsin. Kart üzerindeki "..." menüsünden bilgileri düzenleyebilir, profil fotoğrafı yükleyebilir, öğrenci ve veli telefonu ekleyebilir, öğrenciyi arşivleyebilir ya da kalıcı silebilirsin. Öğrenci ekleme/düzenleme formunda sınıf artık 7. Sınıf\'tan 12. Sınıf\'a kadar (+ Mezun) seçilebiliyor — önceden yalnızca 12. Sınıf ve Mezun vardı. 7. ya da 8. Sınıf seçildiğinde Alan (SAY/EA/SÖZ) sorusu kayboluyor ve kartta alan rozeti basılmıyor, çünkü LGS\'te alan kavramı yok; alan yalnızca 9. Sınıf ve üzeri için geçerli. Düzeltme: profildeki "Konu Yeterliliği" sekmesi artık bütün dersleri gösteriyor — önceden ders adları eski bir listeyle eşleştirildiği için 14 dersten yalnızca 4\'ü (Tarih, Coğrafya, Felsefe, Din Kültürü) görünüyor, geri kalanı sessizce eksik kalıyordu.',
  ...
  },
  {
    ...
    body: 'Sınav adı, yayıncı, tarih ve bölüm bazlı doğru/yanlış sayılarını girersin; net hesaplaması (Doğru − Yanlış ÷ 4) otomatik yapılır. Sağ tarafta geçmiş denemeler listelenir; bir denemeye tıklarsan altında bölüm tablosu açılır (Bölüm · Doğru · Yanlış · Boş · Soru · Net ve Toplam satırı). "Tüm Deneme Geçmişi" sekmesinde tüm öğrencilerin denemeleri tek tabloda aranabilir ve aynı şekilde tıklanıp detaylandırılabilir. Açılan tablonun altındaki "Sonucu WhatsApp ile gönder" ile deneme sonucunu bölüm dökümü ve toplam netiyle birlikte öğrenciye, veliye ya da her ikisine iletebilirsin. 8. Sınıf bir öğrenciye deneme girerken artık LGS bölümleri çıkıyor (Türkçe, Matematik, Fen Bilimleri, T.C. İnkılap Tarihi ve Atatürkçülük, Din Kültürü ve Ahlak Bilgisi, Yabancı Dil — toplam 90 soru) ve net hesaplaması LGS kuralına göre yapılır: 3 yanlış 1 doğruyu götürür (YKS\'de bu 4\'tür). Derslerin katsayısı farklı olduğu için toplamda ayrıca katsayılı "ağırlıklı net" gösterilir. Not: bu, gerçek 500 puanlık LGS puanı DEĞİLDİR — o puan yalnızca o yıl sınava giren herkesin sonucuyla (merkezî istatistiklerle) hesaplanabilir, uygulama böyle bir veri olmadan puan üretmez, yalnızca ağırlıklı neti gösterir.',
  ...
  },
  {
    ...
    body: 'Ders ve konu listesini burada düzenlersin — ekleme, yeniden adlandırma, sıralama ve pasifleştirme. Ekran artık YKS ve LGS olmak üzere iki sekmeye ayrıldı, her sekme kendi derslerini gösterir ve sekme başlığında o müfredatın ders sayısı yazar. YKS sekmesinde bugüne kadarki 14 ders (187 konu, TYT dersleri + 4 AYT dersi: Matematik, Fizik, Kimya, Biyoloji) var — 9, 10, 11, 12. Sınıf ve mezunlar bundan sorumlu. LGS sekmesinde 6 ders (47 konu, 90 soru: Türkçe, Matematik, Fen Bilimleri, T.C. İnkılap Tarihi ve Atatürkçülük, Din Kültürü ve Ahlak Bilgisi, Yabancı Dil) var, şimdilik 8. Sınıfa tanımlı — 7. Sınıf müfredatı geldiğinde aynı yere eklenecek. Hangi öğrencinin hangi müfredatı göreceği sınıfına göre kendiliğinden belirlenir: 7. ve 8. Sınıf yalnız LGS, 9. Sınıf ve üzeri yalnız YKS görür — bu ayrım Konu Yeterlilik Haritası, Haftalık Program, Haftalık Görüşme ve öğrenci profilindeki Konu Yeterliliği sekmesinin hepsinde geçerlidir.',
  ...
  },
{
    ...
    body: 'Sistemde kim hangi kaydı oluşturdu, değiştirdi ya da sildi. Bir satıra tıklayınca değişikliğin alan bazlı dökümü açılır: hangi alan, önceki değer, yeni değer. Kayıt türüne ve işleme göre filtrelenebilir. Kim sütununu okurken üç kaynağı ayırt et: panelden yapılanlar kullanıcının adıyla, öğrencinin mobil portalda yaptıkları "Öğrenci (portal)" olarak, gece yedeği gibi otomatik işler "Sistem" olarak görünür. Erişim kodları kayda maskelenerek yazılır — geçmişten kimsenin PIN\'i okunamaz.',
    usage: 'Bir verinin neden değiştiğini ya da bir hatayı kimin ne zaman yaptığını bulmak istediğinde. Yer büyürse "Arşivle (JSON)" ile indirip bir tarihten öncesini "Temizle" ile silebilirsin; temizliğin kendisi de kaydedilir ve o kayıt asla silinmez. Bu ekranı yalnız sen görürsün — kurum yöneticileri dahil kimse erişemez.',
  },
]
